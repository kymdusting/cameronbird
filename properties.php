...
<!-- Main Container
================================================== -->
<div id="properties" class="site_container container">
        ...
        <div class="columns sixteen">
            ...
            <div class="property columns twelve">
                ...
                <dl>
                    ...
                    <dt>Priced from:</dt><dd>$343,763</dd>
                    <dt>Rental Return:</dt><dd>1 bedroom: $345 - $395 per week (market rent)<br>2 bedroom: $405 - $455 per week (market rent)</dd>
                </dl>
                <ul>
                    <li>Cash Flow Positive</li>
                ...
                <p>Less then 10km north of Brisbane CBD, these 1 &amp; 2 bedroom apartments are situated within a buzzing community of schools, restaurants, pubs, night clubs and sporting facilities, not to mention QLD’s largest Shopping Prescient - Westfield</p>
                <p>*Forecasts and estimations based on research conducted by the Cameron Bird Group.</p>
                <a href="mailto:admin@cameronbird.com.au" class="btn_readmore">Contact Cameron Bird</a>
                <div class="clear"><!-- ClearFix --></div>
            </div>
            ...
            <div class="property columns twelve">
                ...
                <dl>
                    ...
                    <dt>Priced from:</dt><dd>$282,500</dd>
                    <dt>Rental Return:</dt><dd>1 bedroom: $280 - $300 per week (market rent)<br>2 bedroom: $375 - $400 per week (market rent)<br>2 bedroom (dual key) : $510-$560 per week (market rent)<br>3 bedroom (dual key) : $635 per week (market rent)</dd>
                </dl>
                <ul>
                    <li>Cash Flow Positive</li>
                    <li>NRAS allocations available</li>
                ...
                <p>Stage 2 consists of 82 apartments located adjacent to the region's largest shopping hub and bustling business centre - yet is also positioned to take advantage of lakes , green opens spaces and the regions pristine golden beaches, just a stone's throw away.</p>
                <p>*Forecasts and estimations based on research conducted by the Cameron Bird Group.</p>
                <a href="mailto:admin@cameronbird.com.au" class="btn_readmore">Contact Cameron Bird</a>
                <div class="clear"><!-- ClearFix --></div>
            </div>
            ...
            <div class="property columns twelve">
                ...
                <dl>
                    ...
                    <dt>Priced from:</dt><dd>$475,000</dd>
                    <dt>Rental Return:</dt><dd>$725 per week (market rent)</dd>
                </dl>
                <ul>
                    <li>Cash Flow Positive</li>
                ...
                <p>A 10 acre private estate close to Cloncurry’s town centre, transformed into a quality, stylish and safe living environment for it’s residents. Purpose-built to accommodate upper-level mining management and engineers (and their families).</p>
                <p>*Forecasts and estimations based on research conducted by the Cameron Bird Group.</p>
                <a href="mailto:admin@cameronbird.com.au" class="btn_readmore">Contact Cameron Bird</a>
                <div class="clear"><!-- ClearFix --></div>
            </div>
